                            ...
                            <div class="form-group row" >
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="input-group date form_date  " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                  ...
                                  <span class="input-group-text">  <span class="fas fa-calendar fa- text-gray"></span></span>
                              ...
                              <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="lot_no" placeholder="Lot No" name="lot_no">
                              </div>
                            </div>
                            <div class="form-group row">
                             <div class="col-sm-5" >
