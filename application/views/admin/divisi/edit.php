                     ...
                     <div class="row">
                      <div class="col-sm-3">
                       ...
                       <div class="col-sm-6">
                        ...
                        <form class="user" style="text-align: left;" action="<?php echo base_url(). 'index.php/admin/divisi/update'; ?>" method="post">
                          <div class="form-group row" >
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" type="hidden" class="form-control form-control-user" id="kode_divisi" placeholder="Kode Supplier" name="kode_divisi" value="<?php echo $u->kode_divisi ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group row" >
                            <div class="col-sm-5" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="nama_divisi" placeholder="Nama divisi" name="nama_divisi" value="<?php echo $u->nama_divisi ?>">
                            </div>
                          </div>
                        
                          <div class="row">
                          <div class="col-sm-6">
                            <a href="<?php echo base_url(). 'index.php/admin/divisi/index'; ?>" class="btn btn-warning btn-user btn-block"> Cancel
                            </a>
                          </div>
                           <div class="col-sm-6">
