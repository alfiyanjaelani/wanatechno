                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Destination</h1>
                      </div>
                     ...
                     <div class="row">
                      <div class="col-sm-3">
                       ...
                       <div class="col-sm-6">
                        ...
                        <form class="user" style="text-align: left;" action="<?php echo base_url(). 'index.php/admin/destination/update'; ?>" method="post">
                          <div class="form-group row" >
                            <div class="col-sm-5" >
                              <label> Kode Destination</label>
                            </div>
                            <div class="col-sm-1" >
                              <label> : </label>
                            </div>
                            <div class="col-sm-6">
                              <input type="text"  type="hidden" class="form-control form-control-user" id="kode_destination" placeholder="Kode Destination" name="kode_destination" value="<?php echo $u->kode_destination ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group row" >
                            <div class="col-sm-5" >
                              <label> Nama Destination</label>
                            </div>
                            <div class="col-sm-1" >
                              <label> : </label>
                            </div>
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="nama_destination" placeholder="Nama Destination" name="nama_destination" value="<?php echo $u->nama_destination ?>">
                            </div>
                          </div>
                        
                          <div class="row">
                          <div class="col-sm-6">
                            <a href="<?php echo base_url(). 'index.php/admin/destination/index'; ?>" class="btn btn-warning btn-user btn-block"> Cancel
                            </a>
                          </div>
                           <div class="col-sm-6">
