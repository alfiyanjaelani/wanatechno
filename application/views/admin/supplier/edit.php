                    ...
                    <div class="card-body">
                     <div class="row">
                      <div class="col-sm-3">
                       ...
                       <div class="col-sm-6">
                        <?php foreach($mst_supplier as $u){ ?>


                        <form class="user" style="text-align: left;" action="<?php echo base_url(). 'index.php/admin/supplier/update'; ?>" method="post">
                          <div class="form-group row" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" type="hidden" class="form-control form-control-user" id="kode_supplier" placeholder="Kode Supplier" name="kode_supplier" value="<?php echo $u->kode_supplier ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group row" >
                            <div class="col-sm-5" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="nama_supplier" placeholder="Nama Supplier" name="nama_supplier" value="<?php echo $u->nama_supplier ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-sm-5" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="alamat_supplier" placeholder="Alamat" name="alamat_supplier" value="<?php echo $u->alamat_supplier ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-sm-5" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="no_tlp_supplier" placeholder="No Telp" name="no_tlp_supplier" value="<?php echo $u->no_tlp_supplier ?>">
                            </div>
                          </div>
                          <div class="row">
                          <div class="col-sm-6">
