                  ...
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     <div class="row">
                      ...
                      <div class="col-sm-6">
                        <form class="user" style="text-align: left;" action="<?php echo base_url(). 'index.php/admin/barang/tambah_data'; ?>" method="post">
                        <div class="form-group row" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="part_no" placeholder="Part No" name="part_no">
                            </div>
                            <div><?php echo form_error('part_no'); ?>
                            </div>
                          </div>
                          <div class="form-group row" >
                            <div class="col-sm-5" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="part_name" placeholder="Part Name" name="part_name">
                            </div>
                            <div><?php echo form_error('part_name'); ?>
                            </div>
                          </div>
                          <div class="form-group row">
                           <div class="col-sm-5" >
                          ...
                          <div class="col-sm-6" >
                            <select required name="kode_divisi" class="form-control">
                              <option value="" disabled diselected>-- Pilih Divisi --</option>
                              <?php                                
                              foreach ($dd_divisi as $row) {  
