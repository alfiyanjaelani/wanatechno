                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Input Data Sliptype</h1>
                      </div>
                    ...
                    <div class="card-body">
                     <div class="row">
                      <div class="col-sm-3">
                       ...
                       <div class="col-sm-6">
                        <form class="user" style="text-align: left;" action="<?php echo base_url(). 'index.php/admin/sliptype/tambah_data'; ?>" method="post">
                           <div class="form-group row" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="kode_sliptype" placeholder="Kode Sliptype" name="kode_sliptype">
                            </div>
                          </div>
                          <div class="form-group row" >
                            <div class="col-sm-5" >
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control form-control-user" id="nama_sliptype" placeholder="Nama Sliptype" name="nama_sliptype">
                            </div>
                          </div>
